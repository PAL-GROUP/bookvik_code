...
public class ARVideoCanvasHelper : MonoBehaviour, IPlayerPreparedListener
{
    ...
    {
        if (_mediaPlayer != null)
            _mediaPlayer.RemovePreparedEvent(OnPlayerPrepared);
    ...
    /// <summary>
    /// Show/HideAllObjects special video canvas borders in output texture
    /// </summary>
